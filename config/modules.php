...
return [
    'modules' => [
        ...
        ['key' => 'checkinout', 'label' => 'Operations: Check-In & Room Allotment', 'actions' => ['view', 'allot_room', 'confirm_checkin']],
        ['key' => 'checkout_requests', 'label' => 'Operations: Checkout Requests', 'actions' => ['view', 'create', 'start_review', 'assign_inspector', 'manage_dues', 'hold', 'reject', 'final_approve', 'regenerate_exit_token', 'override']],
        ...
        ['key' => 'checkout_gate', 'label' => 'Checkout Gate Management', 'actions' => ['view', 'verify_exit', 'complete_checkout']],
